...
export default function NotFoundPage() {
  return <><SeoHeadComponent title="Page introuvable | L’Ambassade" description="La page demandée est introuvable." path="/404" image="/img/home/header.webp" noIndex />
    <main className="ambassade-inner-page"><NavComponent /><InnerPageHeroComponent image="/img/home/header.webp" title="Page introuvable" tagline="Cette page n’est plus à la carte." />
